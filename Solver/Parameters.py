...
class Parameters:
    def __init__(
        self,
        local_time_zone,
        suitable_schedule_time_from,
        suitable_schedule_time_to,
        less_suitable_schedule_time_from,
        less_suitable_schedule_time_to,
        ...
        presenters_conflicts,
        attendees_conflicts,
        chairs_conflicts,
        presenters_conflicts_timeslot_level,
        attendees_conflicts_timeslot_level,
        small_tz_penalty,
        big_tz_penalty,
    ):
        ...
        self.__submissions_timezones_penalty_weight = (
            submissions_timezones_penalty_weight
        )
    ...
    def setSubmissionsTimezonesPenaltyWeight(
        self, submissions_timezones_penalty_weight
    ):
        self.__submissions_timezones_penalty_weight = (
            submissions_timezones_penalty_weight
        )
    ...
    def setPresentersConflictsTimeslotLevelWeight(
        self, presenters_conflicts_timeslot_level
    ):
        self.__presenters_conflicts_timeslot_level = presenters_conflicts_timeslot_level
